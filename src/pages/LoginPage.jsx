...
function suggestEmail(value) {
  ...
  for (const good of EMAIL_DOMAINS) {
    // one-edit (insert/delete/substitute/transpose) distance from a known domain
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-8">
          <div className="w-full max-w-[360px]">
            ...
            {serverError && (
              <div
                role="alert"
                className="animate-slide-down bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/40 text-red-600 dark:text-red-400 p-3 rounded-lg mb-6 text-sm flex items-start justify-between gap-2"
              >
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`auth-input w-full border dark:bg-gray-800 dark:text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${
                    errors.email
              ...
              <button
                type="submit"
                disabled={loading}
                className="active:scale-95 w-full bg-blue-600 text-white min-h-[52px] py-3.5 rounded-xl text-sm font-semibold hover:bg-blue-700 disabled:opacity-50 transition-all duration-150 flex items-center justify-center gap-2 mt-2 shadow-sm hover:shadow-md"
              >
                {loading && (
