        ...
        if (isDanger && isConfirming) {
          return (
            <div key={i} className="px-3 py-2 bg-red-50 dark:bg-red-950/40">
              <p className="text-[10px] text-red-600 dark:text-red-400 font-semibold mb-1.5">
...
export function useContextMenu() {
  ...
  function ContextMenuPortal() {
    ...
    return createPortal(<Menu x={menu.x} y={menu.y} items={menu.items} onClose={close} />, target)
  }
