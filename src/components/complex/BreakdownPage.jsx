...
const INDEX_OPTIONS = [
  ...
  { id: 1,  label: 'Banking',     short: 'Banking'  },
  { id: 2,  label: 'Development Bank', short: 'Dev Bank' },
  { id: 3,  label: 'Finance',     short: 'Finance'  },
  { id: 4,  label: 'Microfinance',short: 'MFI'      },
  { id: 5,  label: 'Life Insurance', short: 'Life Ins' },
  { id: 6,  label: 'Non-Life Insurance', short: 'NL Ins' },
  { id: 7,  label: 'Hydropower',  short: 'Hydro'    },
  { id: 8,  label: 'Manufacturing', short: 'Mfg'    },
  { id: 9,  label: 'Hotels & Tourism', short: 'Hotels' },
