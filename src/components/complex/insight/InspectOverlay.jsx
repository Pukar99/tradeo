    ...
    <div className="flex flex-col h-full">
      ...
      <div className="shrink-0 px-3 pt-2 pb-2 border-b border-gray-100 dark:border-gray-800 space-y-1.5">
        <div className="flex items-center justify-between">
          <span className={LABEL}>{sectors.length > 1 ? `Sectors · ${sectors.length}` : 'Sector'}</span>
          ...
          <div className="flex gap-1.5">
            <button onClick={() => best.name && onSectorClick({ name: best.name, label: best.label })}
              ...
              <div className="min-w-0 text-left">
                <div className="text-[9px] text-emerald-500 font-bold uppercase tracking-widest leading-none">Top</div>
            ...
            <button onClick={() => worst.name && onSectorClick({ name: worst.name, label: worst.label })}
              ...
              <div className="min-w-0 text-left">
                <div className="text-[9px] text-red-400 font-bold uppercase tracking-widest leading-none">Bottom</div>
...
export default function InspectOverlay({ cell, onClose, onNavigate, onJump, dark, allYears, indexId, onMinimize, activeSector, setActiveSector }) {
  const { loading, candles, stats, sectors, available, dataError, sectorHistory } = useMonthDetail(cell, indexId)
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 bg-white dark:bg-gray-950 flex flex-col"
      ...
      {onJump && allYears?.length > 0 && (
        <div className="shrink-0 flex items-center gap-3 px-4 py-1.5 border-b border-gray-100 dark:border-gray-800 bg-gray-50/60 dark:bg-gray-950/40 overflow-x-auto">
          <span className="text-[10px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500 shrink-0">Year</span>
          <div className="flex items-center gap-1 shrink-0">
          ...
          <span className="text-[10px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500 shrink-0">Month</span>
