...
export const DEFAULT_SETUPS = ['Breakout', 'Reversal', 'Pullback', 'Range Play', 'News', 'SMC', 'Price Action']
...
export const DIRECTION_CFG = {
  LONG:  { label: '↑ Long',  accent: 'bg-emerald-500', pill: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20' },
  SHORT: { label: '↓ Short', accent: 'bg-red-500',     pill: 'bg-red-100 text-red-700 dark:bg-red-500/10 dark:text-red-400 border border-red-200 dark:border-red-500/20' },
}
...
export function computePositionMetrics(position, ltp) {
  ...
  return { wacc, totalQty, ltpNum, isClosed, direction, unrealPnl, pnlValue, hasPnl, slPct, tpPct, rr }
}
