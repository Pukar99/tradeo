...
export default function PartialExitModal({ position, onClose, onSaved }) {
  const [form,        setForm]        = useState({ date: today(), exit_quantity: '', exit_price: '', exit_reason: '', emotional_state: '', post_trade_evaluation: '', lessons_notes: '' })
  ...
  return (
    ...
    >
      <BrokerPasteBox
        ...
        parsed={brokerParsed}
        summary={brokerParsed ? `${brokerParsed.quantity} units @ Rs.${brokerParsed.price} · ${brokerParsed.date}` : ''}
