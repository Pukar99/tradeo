...
// Cleared fields are sent as explicit null — the backend treats null as "clear to SQL NULL".

import { useState, useCallback } from 'react'
import { updateTradeAction } from '../../api'
import { today } from '../../utils/format'
import ModalShell from './ModalShell'
import { EMOTIONAL_STATES, EXIT_REASONS, MARKET_CONDITIONS } from './tradeConstants'
...
export default function EditActionModal({ action, onClose, onSaved }) {
  ...
  return (
    <ModalShell
      title="Edit Action"
      subtitle={`${action.action_type} · ${action.symbol} · ${action.date}`}
      onClose={onClose}
      maxWidth="max-w-md"
      zClass="z-[9999]"
    >
