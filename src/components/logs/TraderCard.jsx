    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span
            style={{ fontSize: 13, fontWeight: 700, color: '#e2e8f0', letterSpacing: '-0.02em' }}
          >
            Tradeo
          </span>
        </div>
      ...
      >
        {[
          ...
          },
          {
            ...
            color:
              winRate !== null ? (parseFloat(winRate) >= 50 ? '#10b981' : '#f87171') : '#94a3b8',
          },
          {
            label: 'Total Trades',
          ...
          },
          {
            ...
            color:
              kpis.profitFactor !== null
                ? kpis.profitFactor === Infinity || kpis.profitFactor >= 1.5
                  ? '#10b981'
                  : kpis.profitFactor >= 1
                    ? '#f59e0b'
                    : '#f87171'
        ...
        <div style={{ display: 'flex', gap: 10, marginBottom: 16 }}>
          {kpis.bestTrade && (
            ...
            >
              ...
              <p style={{ fontSize: 11, fontWeight: 700, color: '#f1f5f9', margin: '2px 0 0' }}>
