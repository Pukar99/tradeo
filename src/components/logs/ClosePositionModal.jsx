...
import { EMOTIONAL_STATES, EXIT_REASONS, EMOTION_COLOR, EXIT_REASON_COLOR, parseBrokerMessage } from './tradeConstants'
...
export default function ClosePositionModal({ position, onClose, onSaved }) {
  const [form,        setForm]        = useState({ date: today(), exit_price: '', exit_reason: '', emotional_state: '', post_trade_evaluation: '', lessons_notes: '' })
  ...
  return (
    ...
    >
      <BrokerPasteBox
        ...
        onClear={() => { setBrokerParsed(null); setBrokerText('') }}
